...
static unsigned int swapctrlfn = 0;
module_param(swapctrlfn, uint, 0444);
MODULE_PARM_DESC(swapctrlfn, "Swap fn and ctrl keys on Apple keyboards ([0] = disabled, "
		"1 = swap)");

static unsigned int use_ejectcd_as_delete = 0;
